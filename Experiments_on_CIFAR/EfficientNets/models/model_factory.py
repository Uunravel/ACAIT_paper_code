...
from models.efficientnet import efficientnet_b0, efficientnet_b3, Margloss, efficientnet_b1, efficientnet_b2, efficientnet_b4, efficientnet_b5, efficientnet_b6, efficientnet_b7
...
def create_model(model_name, model_state_file=None, gpus=[0,1,2,3], label_refinery=None,
                 label_refinery_state_file=None, coslinear=False, scale=5.0):
