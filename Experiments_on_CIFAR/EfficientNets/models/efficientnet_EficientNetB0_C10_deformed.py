...
class CrossEntropyLoss_act(_WeightedLoss):
    ...
    def forward(self, input, target):
        ...
        err = torch.log(torch.exp(err)-0.9)
        return err
...
class EfficientNet(nn.Module):
    ...
    LR_REGIME = [1, 150, 0.1, 151, 225, 0.01, 226, 250, 0.001]
    #def __init__(self, width_mult=1.0, depth_mult=1.0, dropout_rate=0.2, num_classes=10, coslinear=False):
