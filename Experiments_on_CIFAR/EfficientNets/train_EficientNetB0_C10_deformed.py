#!/usr/bin/env python3
"""Script to train a model through refined labels on Cifar10's train set."""
...
from models import model_factory_EficientNetB0_C10_deformed
import opts
import test
import utils
import mul_cifar10
...
def main(argv):
    ...
    train_loader = mul_cifar10.mul_CIFAR10DataLoader(root=args.data_dir, 
        image_size=32, train=True, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
    val_loader = mul_cifar10.mul_CIFAR10DataLoader(root=args.data_dir, 
    ...
    model, loss = model_factory_EficientNetB0_C10_deformed.create_model(
